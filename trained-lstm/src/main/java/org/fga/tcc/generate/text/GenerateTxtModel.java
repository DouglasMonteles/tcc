...
package org.fga.tcc.generate.text;
...
import org.fga.tcc.utils.CharacterIterator;
...
public class GenerateTxtModel {
	...
	static CharacterIterator getShakespeareIterator(int miniBatchSize, int sequenceLength) throws Exception{
		...
		String url = "https://www.gutenberg.org/cache/epub/55682/pg55682.txt";
		String tempDir = System.getProperty("java.io.tmpdir");
		String fileLocation = tempDir + "/pg55682.txt";	//Storage location from downloaded file
